...
`Quosures` can also be used to analyze an expressions. In fact `make_part_number` doesn't do a very good job of this as is. If you experiment with it a little bit you will see that it's easy to give it a part number that is will misinterpret. But all that is for a later tutorials too.
